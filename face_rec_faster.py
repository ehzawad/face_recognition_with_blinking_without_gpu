...
def face_recognize(url = 0):
    ...
    out = cv2.VideoWriter('output.avi', cv2.VideoWriter_fourcc('M','J','P','G'), 200.0, (int(video_capture.get(3)), int(video_capture.get(4))))
    ...
    while True:
        ...
        cv2.putText(rgb_frame, "FPS: {:.1f}".format(fps), (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
